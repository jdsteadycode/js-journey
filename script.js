...
/*
 ANS && Justification.
   Output: B.) Well done!
    ...
    NOTE: This too works when grade is `C`. As grouped-case does contain `case "C"` that logs `Well done!`.
*/
...
/*
 ANS && Justification.
   Output: B.) `"New Orleans"`.
   Here indeed, `user2` is created with the new `@address` but, inside `location` is given the `reference` not, value...
